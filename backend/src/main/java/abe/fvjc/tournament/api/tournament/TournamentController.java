...
class TournamentController {
    ...
    public List<TournamentDto> getAll() {
        final var tournaments = tournamentService.findAll();
    ...
    public TournamentDto start(@PathVariable UUID id) {
        final var tournament = tournamentService.start(TournamentId.of(id));
        return toTournamentDto(tournament);
    }
    ...
    public void delete(@PathVariable UUID id) {
        tournamentService.delete(TournamentId.of(id));
    }
}
