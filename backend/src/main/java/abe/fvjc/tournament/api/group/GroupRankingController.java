...
class GroupRankingController {
    ...
    public GroupRankingDto getGroupRanking(
        ...
        final var ranking = groupRankingService.computeGroupRanking(tournamentId, groupId);
    ...
    public List<GroupRankingDto> getAllGroupRankings(
        ...
        final var rankings = groupRankingService.computeAllGroupRankings(tournamentId, request.getGroups());
